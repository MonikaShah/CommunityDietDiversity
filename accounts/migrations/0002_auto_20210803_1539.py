# Generated by Django 3.2 on 2021-08-03 10:09
...
def load_data(apps, schema_editor):
    ...
    oc = Occupation(occupation="Professional")
    oc.save()
    oc = Occupation(occupation="Business person")
    oc.save()
    oc = Occupation(occupation="Service industry")
    oc.save()
    oc = Occupation(occupation="Homemaker")
    oc.save()
    ...
    oc.save()
    oc = Form(name="moduleTwo")
    oc.save()
    oc = Form(name="moduleThree")
    oc.save()
    ...
    oc.save()
    oc = ReligiousBelief(religion="Buddhiism")
    oc.save()
    ...
    # school
    maha = State.objects.get(state="Maharashtra")
    mum = City.objects.get(city="Mumbai")
    School = apps.get_model("accounts", "School")
    oc = School(name="DSRV", address="Malad", pincode=40032, city=mum, state=maha)
    oc.save()
