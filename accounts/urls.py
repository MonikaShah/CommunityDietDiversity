...
urlpatterns = [
    ...
    path("addSuperCoordinatorForm/", views.addSuperCoordinatorForm, name="add_supercoordinator_form"),
    path("addCoordinatorForm/<int:id>/", views.addCoordinatorForm, name="add_coordinator_form"),
    path("addSessionForm/", views.addSessionForm, name="add_session_form"),
    path("addOrganizationForm/", views.addOrganizationForm, name="add_organization_form"),
